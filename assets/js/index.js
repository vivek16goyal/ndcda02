    ...
    $.ajax({
       ...
       // url: WebSerUrl,
        ...
        success: function (data) {
            ...
            $("#PT_BODY").html("");
            $("#PT_BODY").append("<table  class='CSSTableGenerator' style='border-collapse:collapse;width:100%'><tr><td style='text-align:center;'>Party Code</td><td style='text-align:center;'>Party Name</td><td style='text-align:center;'>Auth MOB No</td></tr>");
            for (var i = 0; i < itm.length; i++) {
                
                if (i == itm.length - 1) {
                    $("#PT_BODY tr:last").after("<tr><td colspan='' style='font-family: Verdana;color:black;font-weight:bold;width:70px;'>" + itm[i].PCODE + "</td><td align='center' style='color:black;font-weight:bold; text-align:center;'>" + itm[i].PNAME + "</td><td style='color:black;font-weight:bold; text-align:center;'>" + itm[i].AUTHMOB + "</td></tr></tbody>");

                } else {
                  
                    $("#PT_BODY tr:last").after("<tr><td colspan='' style='font-family: Verdana;color:black;font-weight:bold;width:70px;'>" + itm[i].PCODE + "</td><td style='color:black;font-weight:bold; text-align:center;'>" + itm[i].PNAME + "</td><td style='color:black;font-weight:bold; text-align:center;'>" + itm[i].AUTHMOB + "</td></tr></tbody>");
                }
            }
            getparty()
        },
